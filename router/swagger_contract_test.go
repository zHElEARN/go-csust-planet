...
func TestSwaggerPreservesExistingHTTPContract(t *testing.T) {
	expected := map[string][]string{
		"GET /admin/announcements":                         {"200", "401", "500", "504"},
		"POST /admin/announcements":                        {"201", "400", "401", "500", "504"},
		"GET /admin/announcements/{id}":                    {"200", "400", "401", "404", "500", "504"},
		"PUT /admin/announcements/{id}":                    {"200", "400", "401", "404", "500", "504"},
		"DELETE /admin/announcements/{id}":                 {"204", "400", "401", "404", "500", "504"},
		"GET /admin/app-versions":                          {"200", "401", "500", "504"},
		"POST /admin/app-versions":                         {"201", "400", "401", "409", "500", "504"},
		"GET /admin/app-versions/{id}":                     {"200", "400", "401", "404", "500", "504"},
		"PUT /admin/app-versions/{id}":                     {"200", "400", "401", "404", "409", "500", "504"},
		"DELETE /admin/app-versions/{id}":                  {"204", "400", "401", "404", "500", "504"},
		"GET /admin/semester-calendars":                    {"200", "401", "500", "504"},
		"POST /admin/semester-calendars":                   {"201", "400", "401", "409", "500", "504"},
		"GET /admin/semester-calendars/{semester_code}":    {"200", "401", "404", "500", "504"},
		"PUT /admin/semester-calendars/{semester_code}":    {"200", "400", "401", "404", "409", "500", "504"},
		"DELETE /admin/semester-calendars/{semester_code}": {"204", "401", "404", "500", "504"},
		"GET /config/announcements":                        {"200", "500", "504"},
		"GET /config/app-versions":                         {"200", "400", "500", "504"},
		"GET /config/app-versions/check":                   {"200", "400", "500", "504"},
		"GET /config/campus-map":                           {"200", "500", "504"},
		"GET /config/semester-calendars":                   {"200", "500", "504"},
		"GET /config/semester-calendars/{semester_code}":   {"200", "400", "404", "504"},
	}
