...
type Config struct {
	...
	CSUSTAuthserverUsername string
	CSUSTAuthserverPassword string
}
...
func InitConfig() {
	...
	AppConfig = &Config{
		...
		CSUSTAuthserverUsername: getEnvOrFatal("CSUST_AUTHSERVER_USERNAME"),
		CSUSTAuthserverPassword: getEnvOrFatal("CSUST_AUTHSERVER_PASSWORD"),
	}
}
